...
//Solution: Record the ugly number sequence in memory. "i_2" is the index of the first element fomr left, whoes double value is greater than the last element. "value_2" is the doble value. "i_3", "i_5", "value_3" and "value_5" have similar meaning. The next element push into the sequence is the minimum of "value_2", "value_3" and "value_5".
